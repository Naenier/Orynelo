...
func TestJSONTimestampsAreAlwaysUTC(t *testing.T) {
	...
	values := []struct {
		...
		{name: "network attempt", value: NetworkAttempt{StartedAt: value, FinishedAt: value}},
		{name: "phase timing", value: PhaseTiming{StartedAt: value, FinishedAt: value}},
		{name: "TLS attempt", value: TLSAttempt{StartedAt: value, FinishedAt: value}},
		{name: "HTTP connect attempt", value: HTTPConnectAttempt{StartedAt: value, FinishedAt: value}},
